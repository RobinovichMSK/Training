...
public class Task3 {
    public static void main(String[] args) {
        ...
        bands.add(new MusicBand("Allla", 1990));
        bands.add(new MusicBand("Piu", 1994));
        bands.add(new MusicBand("KRASKI", 1996));
        bands.add(new MusicBand("ORKI",1999));
        bands.add(new MusicBand("Ruki v Verh",2000));
        bands.add(new MusicBand("SERGEY",2003));
